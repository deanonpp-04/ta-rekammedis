<div class="breadcrumbs">
        <div class="content mt-3">
                ...
                <div class="row">
                        ...
                        <div class="right_col" role="main">
                            <div class="card-header bg-info" >
                                <center> <strong class="card-title text-white"> <h3>LAPORAN DATA PEMERIKSAAN PASIEN</h3></strong></center>
                            </div>
                        <div class="card-body">
                        <div id="body">
                            <form action="<?php echo site_url('dokter/laporan_pemeriksaan/filter_date') ?>" method="POST" target="_blank">
                            ...
                            <!-- <div class="form-group row">
                                        <div class="col-md-5">
                                        <label>Tahun</label>
                                        <input type ="" class="form-control" name="tahun" disabled value="<?php echo date('Y')?>">
                                    </div> -->
                <div class="col-md-5">
            ...
            <div class="form-group row">
                <div class="col-md-5">
                    <button type="submit" class="btn btn-success btn-xm"><i class="fa fa-print"></i> Cetak</button>
                </div>
            </div>
        </form>
    </div>
