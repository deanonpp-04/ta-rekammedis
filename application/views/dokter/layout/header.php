        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <!-- <img src="<?= base_url('assets/upload/logo/'.$setting->logo) ?>" type="image/png">  -->
              <!-- <img src="<?php echo base_url() ?>assets/upload/gambar/dokter.jpg" class="user-image" alt="User Image"> -->
              <span class="hidden-xs"><?php echo $this->session->userdata('username'); ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
               <!--  <img src="<?php echo base_url() ?>assets/upload/gambar/dokter.jpg" class="img-circle" alt="User Image">
 -->
                <p>
