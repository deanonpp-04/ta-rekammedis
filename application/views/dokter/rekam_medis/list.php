...
<div class="row">
    <div class="col-md-12">
        <form method="post" action="<?= base_url('dokter/rekam_medis/search') ?>">
...
<?php if ($rekam_medis != null): ?>
    ...
    <div class="col-md-12">
        ...
        <a target="_blank" href="<?= base_url('dokter/rekam_medis/cetak/'.$nama_pasien->id_pasien) ?>"><button class="btn btn-info"><i class="fa fa-print"></i> Cetak</button></a>
    </div>
