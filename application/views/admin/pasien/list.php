...
<table class="table table-bordered" id="example1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo base_url('admin/pasien/edit/' .$pasien->id_pasien) ?>" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i> Edit</a>
                <a href="<?php echo base_url('admin/pasien/detail2/' .$pasien->id_pasien) ?>" class="btn btn-info btn-xs"> Detail</a>
