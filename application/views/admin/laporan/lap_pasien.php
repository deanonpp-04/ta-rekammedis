                ...
                <div class="row">
                        ...
                        <div class="right_col" role="main">
                            <div class="card-header bg-info" >
                                <center> <strong class="card-title text-white"> <h3>LAPORAN DATA PASIEN</h3></strong></center>
                            </div>
                            <div class="card-body">
                        <div id="body">
                            <form action="<?php echo site_url('admin/laporan_pasien/pasien') ?>" method="POST" target="_blank">
