...
<table style="width: 100%;">
  ...
  <hr class="line-title">
      <center><p><span style="font-size: 30px;  font-weight: bold;">LAPORAN PENDAPATAN PRAKTIK</span></p>
      </center><br><br>
<table>
...
<table class="table1" border="1" width="100%" style="font-size: 22px;text-align:center;" cellspacing="0" >
  ...
  foreach($detail as $key => $result):?>
    <tr>
                ...
                <?php $total = $total+$result['total_biaya']; ?>
                                
	</tr>
            <?php endforeach;?>
            <tr>
                <td colspan="3" style="padding: 25px;" align="center"><b>Total Pendapatan</b></td>
